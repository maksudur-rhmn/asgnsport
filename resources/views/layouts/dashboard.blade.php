...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="description" content="AsgnSport" />
        <meta name="keywords" content="sport,football,soccer" />
        <meta name="author" content="Farahnaz Ahmed" />
        
        <!-- Styles -->
        <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600' rel='stylesheet' type='text/css'>
        <link href="{{ asset('dashboard_assets/assets/plugins/pace-master/themes/blue/pace-theme-flash.css') }}" rel="stylesheet"/>
        <link href="{{ asset('dashboard_assets/assets/plugins/uniform/css/uniform.default.min.css') }}" rel="stylesheet"/>
        <link href="{{ asset('dashboard_assets/assets/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
        <link href="{{ asset('dashboard_assets/assets/plugins/fontawesome/css/font-awesome.css') }}" rel="stylesheet" type="text/css"/>
        <link href="{{ asset('dashboard_assets/assets/plugins/line-icons/simple-line-icons.css') }}" rel="stylesheet" type="text/css"/>	
        <link href="{{ asset('dashboard_assets/assets/plugins/offcanvasmenueffects/css/menu_cornerbox.css') }}" rel="stylesheet" type="text/css"/>	
        <link href="{{ asset('dashboard_assets/assets/plugins/waves/waves.min.css') }}" rel="stylesheet" type="text/css"/>	
        <link href="{{ asset('dashboard_assets/assets/plugins/switchery/switchery.min.css') }}" rel="stylesheet" type="text/css"/>
        <link href="{{ asset('dashboard_assets/assets/plugins/3d-bold-navigation/css/style.css') }}" rel="stylesheet" type="text/css"/>	
        <link href="{{ asset('dashboard_assets/assets/plugins/slidepushmenus/css/component.css') }}" rel="stylesheet" type="text/css"/>
        @yield('top-css')
        
        <!-- Theme Styles -->
        
        <link href="{{ asset('dashboard_assets/assets/css/modern.min.css') }}" rel="stylesheet" type="text/css"/>
        
        <link href="{{ asset('dashboard_assets/assets/css/custom.css') }}" rel="stylesheet" type="text/css"/>
        
        <script src="{{ asset('dashboard_assets/assets/plugins/3d-bold-navigation/js/modernizr.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/offcanvasmenueffects/js/snap.svg-min.js') }}"></script>
    ...
    <body class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile"><img src="{{ asset('dashboard_assets/assets/images/profile-menu-image.png') }}" width="60" alt="David Green"/><span>{{ Auth::user()->name }}</span></div>
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span>Asgnsport</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        ...
                                        <img class="img-circle avatar" src="{{ asset('dashboard_assets/assets/images/avatar1.png') }}" width="40" height="40" alt="">
                                    </a>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span>{{ Auth::user()->name }}<br><small>Super Admin</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li class="@yield('home-active')"><a href="{{ route('home') }}" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        ...
                        <li class="droplink @yield('layout-active')"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th"></span><p>Layouts</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="{{ route('banners.index') }}">Banner Page</a></li>
                                <li><a href="{{ route('match_result.index') }}">Latest Result</a></li>
                                <li><a href="{{ route('match_statistics.index') }}">Match Statistics</a></li>
                                <li><a href="{{ route('about.players') }}">Players</a></li>
            ...
            <div class="page-inner">
                ...
                <div class="page-footer">
                    <p class="no-s">2020 &copy; Developed by Farahnaz Ahmed.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
        ...
        <script src="{{ asset('dashboard_assets/assets/plugins/jquery/jquery-2.1.4.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/pace-master/pace.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/jquery-blockui/jquery.blockui.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/switchery/switchery.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/uniform/jquery.uniform.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/offcanvasmenueffects/js/classie.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/offcanvasmenueffects/js/main.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/waves/waves.min.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/plugins/3d-bold-navigation/js/main.js') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/js/modern.min.js') }}"></script>
